...
impl Raytracer {
    pub fn new(
        ...
        let voxel_materials = SimpleBuffer::new(device, "", COPY_DST | STORAGE);
        ...
        let bind_group = device.create_bind_group(&BindGroupDescriptor {
            ...
            entries: &bind_group_entries!(
                ...
                4 => voxel_materials.0.as_entire_binding(),
    ...
    pub fn recreate_bind_group(&mut self, device: &Device) {
        self.bind_group = device.create_bind_group(&BindGroupDescriptor {
            ...
            entries: &bind_group_entries!(
                ...
                4 => self.voxel_materials.0.as_entire_binding(),
...
pub struct Shaders {
    ...
    pub output_tex_shader: ResultShader,
...
impl Shaders {
    pub fn new(device: &Device, surface_format: TextureFormat, output_size: UVec2) -> Self {
        ...
        let output_tex_shader = ResultShader::new(
            device,
            surface_format,
...
impl<T, const N: usize> SimpleBuffer<[T; N]> {
    pub fn write_slice(&self, queue: &Queue, idx: u64, slice: &[T]) {
